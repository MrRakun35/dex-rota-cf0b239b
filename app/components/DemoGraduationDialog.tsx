...
const DemoGraduationDialog = modal.create<DemoGraduationDialogProps>(
  (props) => {
            ...
            <Box className="oui-flex oui-flex-col oui-gap-6">
              <Box className="oui-flex oui-flex-col oui-gap-4">
                <Text className="oui-text-sm oui-text-base-contrast-80 oui-leading-relaxed">
                  This DEX migrated to a new broker ID, which means all users
                  now have new accounts. Your old demo account is still
                  accessible via the demo platform.
                </Text>

                <Text className="oui-text-sm oui-text-base-contrast-80 oui-leading-relaxed">
                  To access your demo positions, deposits, and trading history,
                  please visit our demo platform.
                </Text>
              </Box>
              ...
              <Box className="oui-text-xs oui-text-base-contrast-54 oui-text-center">
                You can always access your account from the{" "}
                <a
                  href="https://dex.orderly.network/demo"
                  target="_blank"
                  rel="noopener noreferrer"
